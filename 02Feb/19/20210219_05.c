...
int main() {
    ...
    waitWithMessage("Press enter to show rectangle.");

    /* Draw the rectangle between the two points */
    writeRectangleToCanvas(a, b, (char *) canvas, CANVAS_DIMENSION, '@');
    printArray2D((char *) canvas, sizeof(canvas), CANVAS_DIMENSION);
    ...
    /* Let the user input more points/rectangles, if they wish */
