/* Задача 5. Да се напише рекурсивен вариант на функцията за обхождане на двоично дърво.
*        6
*      5   10
*     3   8  13
*    1   7  11  14
...
void printBranches(t_node *start) {
    if (start->left != NULL) {
        printBranches(start->left);
        printf("L ");
    }
    if (start->right != NULL) {
        printBranches(start->right);
        printf("R ");
    }
    printf("%d", start->data);
}
